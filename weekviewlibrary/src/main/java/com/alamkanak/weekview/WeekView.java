...
public class WeekView extends View {
    ...
    private void init() {
        ...
        mTimeTextPaint.setTextSize(mTextSize/2);
...
//                        SimpleDateFormat sdf = mDayNameLength == LENGTH_SHORT ? new SimpleDateFormat("EEEEE M/dd", Locale.getDefault()) : new SimpleDateFormat("EEE M/dd", Locale.getDefault());
                        SimpleDateFormat sdf = mDayNameLength == LENGTH_SHORT ? new SimpleDateFormat("d MMMM yyyy", Locale.getDefault()) : new SimpleDateFormat("d MMMM yyyy", Locale.getDefault());                        return sdf.format(date.getTime()).toUpperCase();
                    } catch (Exception e) {
                        e.printStackTrace();
                        return "";
                    }
